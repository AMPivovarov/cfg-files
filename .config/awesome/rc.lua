...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,             }, "Escape",
              ...
              { group = "tag", description = "view last used" }),

    awful.key({ modkey,             }, "j",
                function() awful.client.focus.byidx( 1) end,
              { group = "client", description = "focus next by index" }),
    awful.key({ modkey,             }, "k",
                function() awful.client.focus.byidx(-1) end,
              { group = "client", description = "focus previous by index" }),
    ...
    awful.key({ modkey              }, "z",
                function() mypromptbox[awful.screen.focused()]:run() end,
